...
import com.example.demo.wangYin.LogUtil;
import com.example.demo.wangYin.SDKConfig;
...
@RequestMapping("/ppp")
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		//前台页面传过来的
		String merId = req.getParameter("777290058170989 ");
		String txnAmt = req.getParameter("1000");
